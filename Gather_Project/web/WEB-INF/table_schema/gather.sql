...
SELECT W_IDX AS WIDX, WORK, W_PROC AS WPROC, TO_CHAR(W_SDATE, 'yyyy-mm-dd' )AS WSDATE,TO_CHAR(W_EDATE, 'yyyy-mm-dd' )AS WEDATE, W_MEM AS WMEM, T_IDX AS TIDX FROM WORK WHERE T_IDX=6;
...
--------------------관리자ID----------------------
INSERT INTO MEMBER VALUES(1, 'admin', 'admin', '신동재');
INSERT INTO MEMBER VALUES(2, 'abcd', 'abcd', '김경동');
INSERT INTO MEMBER VALUES(3, 'cccc', 'cccc', '이성찬');
